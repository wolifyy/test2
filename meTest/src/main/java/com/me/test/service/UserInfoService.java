...
public interface UserInfoService {
    ...
    ResponseB queryByPage(SearchCondition searchCondition, Sorter sorter, Page page);

    Integer queryTotal();

    Boolean addUserInfo(MultipartFile file) throws Exception;
}
